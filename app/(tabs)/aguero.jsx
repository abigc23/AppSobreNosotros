    ...
    <ScrollView className="">
      <View className="p-5">
        ...
        <View className="flex flex-row py-5 items-center justify-center">
          <Image className="w-40 h-40 rounded-lg border p-3" source={imagenes.traficante}/>
          <View className="flex flex-col text-justify p-5 border-b border-t ml-3 items-center justify-center">
            <Text className="text-xs font-medium">Nombre: Mati Aguero</Text>
            <Text className="text-xs font-medium">Apodo: "El Pochola"</Text>
            <Text className="text-xs font-medium">Edad: 18 tiros</Text>
            <Text className="text-xs font-medium">Estado Civil: Buscado</Text>
            <Text className="text-xs font-medium">Nacionalidad: River Plate</Text>
          </View>
        </View>
        <View className="pt-10 text-justify">
          ...
          <Image className="w-40 h-40 flex self-center p-5 justify-center" source={imagenes.caquita} />
          ...
          <Image className="w-40 h-40 flex self-center p-5 justify-center" source={imagenes.baño} />
          ...
          <Image className="w-40 h-40 flex self-center p-5 justify-center" alt='fotos que lo vinculan con la razon de su malintencionar' source={imagenes.pelado} />
          <Text className="p-2">  Varias fuentes, cuentan de primera mano su alta experiencia en el manejo de armas debido a su entrenamiento intensivo es un campo de entrenamiento virtual conocido como el PUG, Practicas Utilitarias Guerrilleras, un sistema de alta capacidad intelectual diseñado para la proliferacion de cyber crimen originada en San Juan, como proyecto escolar de cuarto año.</Text>
          ...
          <Image className="w-40 h-40 flex self-center p-5 justify-center" alt='fotos que lo vinculan con la razon de su malintencionar' source={imagenes.piquito} />
